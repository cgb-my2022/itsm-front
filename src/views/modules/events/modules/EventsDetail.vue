  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      ...
      <div style="margin-top: 5px">
        <staff-service-order-form :formData="formData" :dictOptions="dictOptions" :dictStatus="dictStatus"></staff-service-order-form>
      </div>
      <!-- 操作 -->
      <div v-if="acceptType === 1" style="text-align: center;padding:20px 0;">
        <a-space :size="8" align="center">
          <!-- 未接单 -->
          <template v-if="formData.orderStatus === 1">
            <a-button @click="receiveOrder()" type="primary">接单</a-button>
          </template>
          <!-- 已挂起  -->
    ...
    <!-- 办理 -->
    <events-solution ref="eventsSolution" :categoryOptions="categoryOptions" :formData="formData" @complete="handleDataReload()"></events-solution>
    <!-- 转单 -->
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail() {
        getAction(
          this.url.moreInfo, { id: this.rowId }
        ).then(res => {
