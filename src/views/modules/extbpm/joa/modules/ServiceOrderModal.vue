    ...
    <a-spin :spinning="confirmLoading">
      ...
      <a-form :form="form">
        <a-row>
          ...
          <!--<a-col :xs="24" :sm="12">
            <a-form-item label="工作地点公司" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['workplaceCompany', validatorRules.workplaceCompany]" placeholder="请输入工作地点公司"></a-input>
            </a-form-item>
          </a-col>-->
          <!--  <a-col :xs="24" :sm="12">
            <a-form-item label="工作地点部门" :labelCol="labelCol" :wrapperCol="wrapperCol">
             ...
             &lt;!&ndash; <a-directory-tree
                ...
                :treeData="departTree"
              />&ndash;&gt;
             &lt;!&ndash; <j-dict-select-tag type="list" v-decorator="['workplaceDept']" :trigger-change="true" placeholder="请选择工作地点部门"/>&ndash;&gt;
            </a-form-item>
          </a-col>-->
          <a-col :xs="24" :sm="12">
...
<script>
  ...
  import { postAsyncAction } from '@/api/manage'
