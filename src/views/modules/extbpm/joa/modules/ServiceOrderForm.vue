          ...
          <tr>
            ...
            <td class="firstTr">
              <a-form-item
                ...
                <a-input class="text"  v-decorator="[ 'userName', {}]" />
              </a-form-item>
            </td>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      editAfter() {
        let fieldval = pick(this.model, 'userName','realName', 'phoneNo', 'deptName', 'workplaceDepartids','workplaceDepartnames', 'workplaceDetail', 'businessType','businessName', 'deviceInfo', 'eventContent', 'bpmStatus', 'createTime')
