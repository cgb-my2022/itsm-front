      ...
      <a-divider />
        <div style="text-align: center">
          ...
          <a-space :size="8" align="center">
            <a-button @click="handleOpt('submit')" type="primary" icon="caret-right">办理</a-button>
            <!--<template v-if="!currTask.suspendFlag">
              ...
              <template v-else>
                ...
                &lt;!&ndash;<a-button @click="selectEntruster()" type="primary" icon="user">委托</a-button>
            <a-button @click="handleSuspend()" type="primary" icon="lock">挂起</a-button>&ndash;&gt;
              </template>
            </template>
            <template v-else>
