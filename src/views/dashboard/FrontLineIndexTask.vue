      ...
      <a-row type="flex" justify="start" :gutter="3">
        <a-col style="padding-top: 10px" :sm="24" :lg="12">
          <div class="card-head">
            ...
            <p class="card-head-p2" @click="toServiceOrderReceiveList">更多 <a-icon type="double-right" /></p>
          </div>
          <div class="card-tb">
        ...
        <a-col style="padding-top: 10px" :sm="24" :lg="12">
          <div class="card-head">
            <p class="card-head-p1">
              <span class="card-head-p1-span1">在办事件</span>
              <span class="card-head-p1-span2">({{ dataSource2Size }})</span>
            </p>
            <p class="card-head-p2" @click="toServiceOrderReceiveList">更多 <a-icon type="double-right" /></p>
          </div>
          <div class="card-tb">
            <a-table :columns="columns" :dataSource="dataSource2" :pagination="false">
              <template slot="ellipsisText" slot-scope="text">
                <j-ellipsis :value="text" :length="textMaxLength"></j-ellipsis>
              </template>
